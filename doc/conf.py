# -*- coding: utf-8 -*-
#
# slist documentation build configuration file
#
...
#latex_documents = [
#  ('index', 'felix.tex', u'Felix Documentation',
#   u'John Skaller et al', 'Felix'),
#]
...
texinfo_documents = [
  ('index', 'slist', u'Slist Documentation',
   u'John Skaller', 'slist', 'Slist',
   'Miscellaneous'),
]
